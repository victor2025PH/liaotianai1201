...
"""
    ...
    # 写入临时文件
    sftp = ssh.open_sftp()
    with sftp.file('/tmp/liaotian-frontend-new.service', 'w') as f:
        f.write(service_config)
    sftp.close()
    
    # 复制到systemd目录
    run_ssh(ssh, "sudo cp /tmp/liaotian-frontend-new.service /etc/systemd/system/liaotian-frontend.service")
    print("[OK] 新配置已创建\n")
