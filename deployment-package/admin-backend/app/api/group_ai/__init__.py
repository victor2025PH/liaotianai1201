...
# 导入基础模块
from app.api.group_ai import accounts, scripts, monitor, control, role_assignments, script_versions, servers, logs, dashboard, alert_rules, dialogue, redpacket, script_review, role_assignment_schemes, export, automation_tasks, telegram_alerts, session_export
...
# 暫時移除路由級別的認證依賴，允許測試時匿名訪問
# 生產環境應重新啟用認證：dependencies=[Depends(get_current_active_user)]
router = APIRouter(
    prefix="/group-ai",
    tags=["group-ai"],
)
